...
public class ObserverResponseWhitError<BaseResponse, ErrorResponse> extends ObserverResponse<BaseResponse>{
    ...
    private static final String TAG = "THEMOVIEDB_" + ObserverResponseWhitError.class.getSimpleName();
    ...
    public ErrorResponse getError(){
        try {
            ...
            Gson gson = new Gson();
            return gson.fromJson(errorResponse.toString(), persistentErrorResponse);
        } catch (Exception e) {
